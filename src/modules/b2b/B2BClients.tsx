...
export default function B2BClients({ onOpenOrder, onCreateOrder, userName = 'CRM', canViewFinance = true, canEditPaymentStatus = false }: B2BClientsProps) {
          ...
          <article className="b2b-client-profile" role="dialog" aria-modal="true" aria-labelledby="b2b-client-card-title">
            <header className="b2b-client-profile-head">
              ...
              <div className="b2b-client-profile-summary">
                ...
                {onCreateOrder && <button type="button" className="b2b-client-new-order" onClick={() => onCreateOrder(selectedClient.id)} aria-label="Добавить новый заказ клиенту"><Plus size={16} /></button>}
